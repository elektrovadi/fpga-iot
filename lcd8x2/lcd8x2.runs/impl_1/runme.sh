...
HD_PWD='D:/PROJECTs/lcd8x2/lcd8x2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd8x2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd8x2.tcl -notrace
