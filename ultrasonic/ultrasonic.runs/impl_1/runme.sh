...
HD_PWD='C:/Users/ARGE2/Desktop/Projeler/FPGA Gelistirme kart/ultrasonic/ultrasonic/ultrasonic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ultrasonic.tcl -notrace
