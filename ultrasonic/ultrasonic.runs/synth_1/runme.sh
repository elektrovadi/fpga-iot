...
HD_PWD='C:/Users/ARGE2/Desktop/Projeler/FPGA Gelistirme kart/ultrasonic/ultrasonic/ultrasonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultrasonic.tcl
